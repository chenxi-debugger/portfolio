    ...
    return (
      <div>
        ...
        <p className="text-lg text-gray-300 mb-10">
          I am a motivated and detail-oriented Software Engineer from California, United State, with hands-on experience in full-stack web development, modern JavaScript frameworks, and backend technologies, and more to contribute effectively to a dynamic development team.
        </p>
